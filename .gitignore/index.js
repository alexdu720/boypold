...
client.login("NTIyMTI0ODczNzU0MjE0NDEw.DvGegA.ENFOIEbwjB36FsCFNjqGFEazyhI");
...
client.on("ready", () => {
    ...
    client.user.setActivity("faire des Tutos :D");
...
client.on('guildMemberAdd', member => {
    ...
    const welcomechannel = member.guild.channels.find('id', '522137015647600688') // ID de notre channel
    var embed = new Discord.RichEmbed()
    .setColor('#76D880')
    .setDescription(`:inbox_tray: Bonjour, Bonsoir

    Bienvenue <@${member.user.id}> sur le serveur dédié aux Bas Gradés, Haut Gradés et Président de l'Assemblée Générale de l'ONU Of Habbo. Je te prierai de mettre ton pseudo Habbo et d'attendre que le @Président AG ou un @Haut Gradé te donne ton rôle correspondant à ton grade. Si tu as le moindre soucis, dirige toi vers tes Superviseurs ou le Président de l'Assemblée Générale.`)
    ...
    client.on('message', message => {
        ...
        message.reply('Et gigi refusa la proposition, que cela vous serve de leçons')
        }
        })
